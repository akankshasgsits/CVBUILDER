...
if (isset($_POST['signup'])) {
  ...
  $insert = signup($data, $con);
  if ($insert == "0") {
    echo "<script> alert('User is already registered..!'); </script>";
  } else {
    echo "<script> alert('Registered Successfully..!'); </script>";
    setcookie('user', $insert['id'], time() + 86400 * 60, '/');
    header("location:index.php");
  }
}
        ...
        <ul>
          ...
          <?php if (!isset($_COOKIE['user'])) { ?>
            <li><button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal">Login</button>
              ...
              <?php if (isset($_GET['reset']) && isset($_POST['email']) && isset($_POST['phone'])) { ?>
                &nbsp; &nbsp;
                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#reset">Reset Your Password</button>
              <?php } else { ?>
                &nbsp; &nbsp;
                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModalsignup">Sign up</button>
              <?php } ?>
            </li>
          <?php } else { ?>
    ...
    <div class="modal fade" id="forgot" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="index.php?reset=true" method="post">
              <div class="form-group">
          ...
          <div class="modal-body">
            <form action="" method="post">
              <div class="form-group">
                ...
                <input type="hidden" name="uid" value="<?= $resetData['id'] ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="float-right">
                  <button class="btn btn-success mr-3" type="submit" name="reset">Save</button>
                </div>
              </div>
            </form>
          </div>
